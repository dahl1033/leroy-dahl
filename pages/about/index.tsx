    ...
    <div className="flex flex-col h-full p-8">
      ...
      <div className="flex flex-col-reverse sm:flex-row mt-8">
        <div className="flex flex-col mt-8">
          <h1 className="text-6xl font-bold text-black md:mb-1 mt-6 dark:text-white sm:leading-tight">
            {`When I'm not skiing in goofy outfits, I'm building things.`}
          </h1>
          <h3 className="text-sm text-gray-500 mt-6">{`From ground up projects to feature development, scroll and click to find out more.`}</h3>
        </div>
      ...
      <div className="md:flex md:flex-col md:justify-end mt-96">
