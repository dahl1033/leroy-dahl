...
function MyDialog() {
  ...
  return (
    <Dialog open={isOpen} onClose={() => setIsOpen(false)} className={`fixed inset-0 z-10 overflow-y-auto flex justify-center items-center`}>
      ...
      <Dialog.Panel className={` bg-${bgColor}-500 z-50 inset-1/4 lg:m-[50%md:m-[25%] sm:m-[25%] m-4 flex flex-col justify-center items-center rounded-lg p-8`}>
  ...
  return (
    <div className="flex flex-col h-full p-8">
      ...
      <div className="flex sm:flex-col-reverse flex-col md:flex-row ">
        <div className="md:flex md:flex-col md:justify-end md:w-2/3">
          <h1 className="text-7xl font-bold text-gray-400 dark:text-white mb-8">
            ...
            <span id="productHover" onClick={handleClick} className="hover:p-1 hover:cursor-pointer bg-gradient-to-r from-purple-500 to-pink-500 text-transparent bg-clip-text"> My Toolkit</span>
          </h1>
        </div>
      ...
      <div className="flex flex-col-reverse sm:flex-row  w-full gap-2">
        ...
        <div id="togo" className=" w-full flex flex-col   items-center px-6 dark:border-transparent p-6">
